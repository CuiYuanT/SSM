...
<div class="page-container">
   <form action="${ctx}/student/findBySql" method="post">
   <div class="text-c"> 
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	    <span class="l">  
	                      <a href="javascript:;" onclick="admin_add('添加','${ctx}/student/add','600','300')" class="btn btn-primary radius">
	                      <i class="Hui-iconfont">&#xe600;</i>  添加</a></span>
	                     <span class="r">
	                     <div class="panel-foot text-center">
      <pg:pager  url="${ctx}/student/findBySql" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
		<pg:last>  
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
		 ...
		 <tr class="text-c">
				...
				<td>${data.bj.name}</td>
				<td class="td-manage">
				 <a title="编辑" href="${ctx}/student/update.do?id=${data.id}" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function admin_del(id){
	layer.confirm('确认要删除吗？',function(index){
		window.location.href=ctx+"/student/delete?id="+id;
	});
}
</script>
</body>
