...
<div class="page-container">
 ...
 <!--   <div class="text-c"> 
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
      ...
      <pg:pager  url="${ctx}/qj/findBySql" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
		<pg:last>  
		...
		<tbody>
		 ...
		 <tr class="text-c">
				...
				<c:if test="${data.status == 0 }">
								 <a title="审核" href="${ctx}/qj/view.do?id=${data.id}" class="ml-5" style="text-decoration:none">
