...
<div class="page-container">
   <form action="${ctx}/bj/findBySql" method="post">
   <div class="text-c"> 
		<input type="text" class="input-text" style="width:250px" placeholder="名称" id="" name="name">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	    <span class="l">  
	                      <a href="javascript:;" onclick="admin_add('添加','${ctx}/bj/add','600','300')" class="btn btn-primary radius">
	                      <i class="Hui-iconfont">&#xe600;</i>  添加</a></span>
	                     <span class="r">
	                     <div class="panel-foot text-center">
      <pg:pager  url="${ctx}/bj/findBySql" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
		<pg:last>  
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
		 ...
		 <tr class="text-c">
				...
				<td>${data.zy}</td>
				<td class="td-manage">
				 <a title="编辑" href="${ctx}/bj/update.do?id=${data.id}" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function admin_del(id){
	layer.confirm('确认要删除吗？',function(index){
		window.location.href=ctx+"/bj/delete?id="+id;
	});
}
</script>
</body>
