...
<div class="page-container">
   <form action="${ctx}/sign/fdySign" method="post">
   ...
   <div class="text-c"> 
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
      ...
      <pg:pager  url="${ctx}/sign/fdySign" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
		 ...
		 <tr class="text-c">
				...
				<td>${data.name}</td>
				<td class="td-manage">
			<a title="查看签到记录" href="${ctx}/record/fdyRecord.do?signId=${data.id}" class="ml-5" style="text-decoration:none">
