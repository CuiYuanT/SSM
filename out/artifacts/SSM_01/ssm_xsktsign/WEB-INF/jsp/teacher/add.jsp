...
<article class="page-container">
	...
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add" action="${ctx}/teacher/exAdd" method="post">
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="adminName" name="password">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>工号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="adminName" name="code">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>课程名：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="kc" name="kc">
		</div>
	</div>
						...
						<dl class="cl permission-list2">
							<dd>
							      <c:forEach items="${bjs}" var="data" varStatus="l">
								      <label class="">
										<input type="checkbox" value="${data.id}" name="ids" id="user-Character-0-0-0">
										${data.name}
									</label>
							      </c:forEach>
